...
epicsEnvSet("IOCNAME", "ioc-plc-cvmi-vac" )
epicsEnvSet("ENGINEER", "adpai" )
epicsEnvSet("LOCATION", "PLC:plc_cvmi_vac" )
...
dbLoadRecords("iocSoft.db", "IOC=PLC:plc_cvmi_vac")
dbLoadRecords("save_restoreStatus.db", "P=PLC:plc_cvmi_vac:")
...
save_restoreSet_status_prefix( "PLC:plc_cvmi_vac:" )
